...
public class DefaultConditionRunner implements ConditionRunner {
  ...
  public interface Monitor {
     ...
     */
    void waitHasBegun(Context context, Condition condition);
     ...
     */
    void conditionWasReached(Context context, Condition condition);

    void conditionFailed(Context context, Condition condition, String message);
  }
  ...
  public static final class NoOpMonitor implements Monitor {
    ...
    public void waitHasBegun(Context context, Condition condition) {
    }

    public void conditionWasReached(Context context, Condition condition) {
    }
