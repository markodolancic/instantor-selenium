...
import org.openqa.grid.web.servlet.handler.*;
...
public class TestSession {
    ...
    private HttpRequest prepareProxyRequest(HttpServletRequest request/*, ForwardConfiguration config*/) throws IOException {
        URL remoteURL = slot.getRemoteURL();
